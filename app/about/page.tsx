            ...
            <section className="py-16 bg-white/5">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
                        ...
                        <div className="bg-gradient-to-br from-white/10 to-transparent p-8 rounded-2xl border border-white/10">
                            <h3 className="text-xl font-bold text-white mb-4">A Note From Our Founder</h3>
                            ...
                            <div className="flex items-center">
                                <div className="h-10 w-10 rounded-full bg-gray-600 mr-4" /> {/* Placeholder avatar */}
                                <div>
